        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="container">
                    <div id='content-wrap'>
                        <div class="top inner">
                            This is RSS Feed generated by
                            <a href="https://github.com/bxb100/issueblog" target="_blank">Issue Blog Action</a>.
                            RSS reader apps can use the URL in the address bar.
                        </div>
                        ...
                        <xsl:for-each select="/rss/channel/item">
                            <xsl:sort select="enclosure/@url" order="descending"/>
                    ...
                    <div id='foot'>
                        <a class="title" href="https://github.com/marketplace/actions/issue-blog">GitHub Action</a>
                        <nav>
                            <a href="https://github.com/bxb100/issueblog-test">DEMO</a>
                            <a href="https://github.com/bxb100/issueblog/blob/main/README.md">README</a>
                        </nav>

                        <div class="right"><a href="https://github.com/bxb100"><span>❤️ bxb100</span></a></div>
                    </div>
                </div>
            </body>
        </html>
